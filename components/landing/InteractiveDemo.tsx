...
export function InteractiveDemo() {
  ...
  return (
    <section id="playground" className="bg-white mx-auto max-w-4xl px-6 py-20">
      <div className="rounded-2xl border border-zinc-200/90 bg-white p-8 sm:p-12 text-center shadow-sm">
        <div className="inline-flex items-center gap-2 rounded-full border border-blue-200/80 bg-blue-50 px-3 py-1 text-xs font-mono font-medium text-blue-800 mb-4">
          <Play className="w-3 h-3 fill-blue-800 text-blue-800" />
        ...
        <div className="my-8 flex min-h-[160px] items-center justify-center rounded-xl border border-zinc-200 bg-white p-8 shadow-inner bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] [background-size:16px_16px]">
        ...
        {/* Custom Input */}
        <div className="max-w-xs mx-auto flex items-center gap-2 rounded-lg border border-zinc-200 bg-zinc-50/70 px-3 py-1.5 focus-within:border-blue-400 focus-within:bg-white transition-all">
